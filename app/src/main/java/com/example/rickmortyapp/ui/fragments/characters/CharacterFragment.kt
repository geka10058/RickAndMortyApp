...
import com.example.rickmortyapp.ui.adapters.OnResultItemClickListener

class CharacterFragment : Fragment(R.layout.fragment_character), OnResultItemClickListener {
