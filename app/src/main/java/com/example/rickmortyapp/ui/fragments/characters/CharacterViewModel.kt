...
import com.example.rickmortyapp.data.retrofit_controllers.CharacterResponseRetrofitController

class CharacterViewModel:ViewModel() {

    private val controller = CharacterResponseRetrofitController()
